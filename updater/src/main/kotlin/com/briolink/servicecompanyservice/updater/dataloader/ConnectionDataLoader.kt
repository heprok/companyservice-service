                            ...
                            Connection(
                                    ...
                                    participantFrom = ConnectionParticipant(
                                            ...
                                            companyRole = listConnectionRole.shuffled()
                                                    .find { connectionRoleReadEntity -> connectionRoleReadEntity.type == ConnectionCompanyRoleType.Seller }!!,
                                    ),
                                    participantTo = ConnectionParticipant(
                                            ...
                                            companyId = to.id,
                                            companyRole = listConnectionRole.shuffled()
                                                    .find { connectionRoleReadEntity -> connectionRoleReadEntity.type == ConnectionCompanyRoleType.Buyer }!!,
                                    ),
